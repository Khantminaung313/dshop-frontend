	...
	return (
		<tr className="*:py-2">
			...
			<td className="space-x-3">
				<button className="px-2 py-1 rounded border border-orange-500">
					Edit
				</button>
				<button className="px-2 py-1 rounded border border-red-500" onClick={handleDelete}>
					Delete
				</button>
			</td>
		</tr>
